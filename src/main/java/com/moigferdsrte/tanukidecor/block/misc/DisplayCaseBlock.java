...
import com.moigferdsrte.tanukidecor.block.entity.DisplayBlockEntity;
...
import com.moigferdsrte.tanukidecor.block.entity.SingleSlotBlockEntity;
...
public class DisplayCaseBlock extends RotatingTallBlock implements EntityBlock, IDisplayProvider {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if (pPos.equals(getDelegatePos(pState, pPos))) {
            return new DisplayBlockEntity(TDRegistry.BlockEntityReg.DISPLAY_CASE, pPos, pState);
        }
