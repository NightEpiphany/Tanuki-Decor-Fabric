...
public class CabanaWardrobeBlock extends RotatingMultiblock implements EntityBlock {

    public CabanaWardrobeBlock(Properties pProperties) {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if (pPos.equals(getDelegatePos(pState, pPos))) {
            return new StorageBlockEntity(TDRegistry.BlockEntityReg.CABANA_WARDROBE, pPos, pState, 6);
        }
    ...
    public static final VoxelShape[][][] SHAPE = new VoxelShape[][][]{
            ...
            // height = 1
            {
                    ...
                    // width = 1
                    {
                            Shapes.or(box(14, 0, 0, 16, 2, 2),
                                    box(14, 0, 14, 16, 2, 16),
                                    box(0, 2, 0, 16, 16, 16))
                    },
                    // width = 2
                    {
                            Shapes.or(box(0, 0, 0, 2, 2, 2),
                                    box(0, 0, 14, 2, 2, 16),
                                    box(0, 2, 0, 16, 16, 16))
                    }
            },
