...
public class RegalBookshelfBlock extends RotatingMultiblock implements EntityBlock {
    ...
    public RegalBookshelfBlock(Properties pProperties) {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if (pPos.equals(getDelegatePos(pState, pPos))) {
            return new StorageBlockEntity(TDRegistry.BlockEntityReg.REGAL_BOOKSHELF, pPos, pState, 6);
        }
    ...
    public static VoxelShape buildShape(final BlockState blockState) {
        ...
        return index.getY() == 0 ? SHAPE_LOWER : SHAPE_UPPER;
    }
}
