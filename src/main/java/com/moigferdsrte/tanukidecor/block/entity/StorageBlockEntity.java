...
public class StorageBlockEntity extends RandomizableContainerBlockEntity {
    ...
    @Override
    protected @Nullable AbstractContainerMenu createMenu(int pContainerId, Inventory pInventory) {
        return switch (rows) {
            case 1 -> new ChestMenu(MenuType.GENERIC_9x1, pContainerId, pInventory, this, rows);
            case 2 -> new ChestMenu(MenuType.GENERIC_9x2, pContainerId, pInventory, this, rows);
            case 3 -> ChestMenu.threeRows(pContainerId, pInventory, this);
            case 4 -> new ChestMenu(MenuType.GENERIC_9x4, pContainerId, pInventory, this, rows);
            case 5 -> new ChestMenu(MenuType.GENERIC_9x5, pContainerId, pInventory, this, rows);
            case 6 -> ChestMenu.sixRows(pContainerId, pInventory, this);
            default -> null;
        };
    }
