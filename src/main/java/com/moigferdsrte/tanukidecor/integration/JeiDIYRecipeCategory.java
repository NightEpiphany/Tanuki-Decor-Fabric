...
public class JeiDIYRecipeCategory implements IRecipeCategory<DIYRecipe> {
    ...
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "diy");
    public static final RecipeType<DIYRecipe> RECIPE_TYPE = new RecipeType<>(UID, DIYRecipe.class);

    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "textures/jei/diy_recipe.png");
    ...
    public JeiDIYRecipeCategory(final IGuiHelper guiHelper) {
        this.background = guiHelper.drawableBuilder(TEXTURE, 0, 0, 117, 62)
                ...
                .build();
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(TDRegistry.BlockReg.DIY_WORKBENCH));
