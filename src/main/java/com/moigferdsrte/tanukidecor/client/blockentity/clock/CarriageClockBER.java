...
public class CarriageClockBER extends ClockBER {
    ...
    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/carriage_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/carriage_clock/short_hand");
    public static final ResourceLocation GEAR = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/carriage_clock/gear");
    private static final ModelResourceLocation GEAR_MODEL = TanukiDecorFabricClient.standalone(GEAR);
