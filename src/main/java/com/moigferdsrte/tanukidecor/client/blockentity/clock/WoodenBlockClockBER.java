...
public class WoodenBlockClockBER extends ClockBER {

    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/wooden_block_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/wooden_block_clock/short_hand");
    public static final ResourceLocation PENDULUM = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/wooden_block_clock/pendulum");
    ...
    public WoodenBlockClockBER(BlockEntityRendererProvider.Context pContext) {
        super(pContext, SHORT_HAND, LONG_HAND,
                ROOT_POSITION,
                ROOT_PIVOT_POINT,
                new Vec3(-8.0D / 16.0D, -24.0D / 16.0D, 0),
    ...
    public void renderAdditional(ClockRenderHelper renderHelper, ClockBlockEntity blockEntity, MultiBufferSource bufferSource) {
        ...
        renderHelper
                .withModel(pendulum)
                .withPosition(new Vec3(-8.0D / 16.0D, -24.0D / 16.0D, 0))
                .withPivotPoint(new Vec3(8.0D / 16.0D, 6.0D / 16.0D, 0))
