...
public class LargeClockTowerDialBER extends ClockBER {
    ...
    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/large_clock_tower_dial/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/large_clock_tower_dial/short_hand");
