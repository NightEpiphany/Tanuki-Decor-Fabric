...
public class OwlClockBER extends ClockBER {

    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/owl_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/owl_clock/short_hand");
    public static final ResourceLocation PENDULUM = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/owl_clock/pendulum");
