...
public class GorgeousClockBER extends ClockBER {
    ...
    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/gorgeous_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/gorgeous_clock/short_hand");
    public static final ResourceLocation PENDULUM = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/gorgeous_clock/pendulum");
