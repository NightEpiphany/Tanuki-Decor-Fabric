...
import com.moigferdsrte.tanukidecor.block.entity.GlobeBlockEntity;
...
public class GlobeBER implements BlockEntityRenderer<GlobeBlockEntity> {
    ...
    public static final ResourceLocation GLOBE_MODEL = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/globe/globe_model");
    ...
    public void render(GlobeBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
        ...
        final BakedModel globeModel = mc.getModelManager().getModel(TanukiDecorFabricClient.standalone(GLOBE_MODEL));
