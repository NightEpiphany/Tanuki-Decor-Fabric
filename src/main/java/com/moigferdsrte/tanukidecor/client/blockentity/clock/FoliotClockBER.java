...
public class FoliotClockBER extends ClockBER {
    ...
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/foliot_clock/short_hand");
    public static final ResourceLocation GEAR = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/foliot_clock/gear");
