...
public class RecognizableClockBER extends ClockBER {
    ...
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/recognizable_clock/short_hand");
    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/recognizable_clock/long_hand");
