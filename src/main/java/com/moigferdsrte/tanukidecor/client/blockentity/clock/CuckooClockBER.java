...
import com.moigferdsrte.tanukidecor.block.clock.IChimeProvider;
...
public class CuckooClockBER extends ClockBER {
    ...
    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/cuckoo_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/cuckoo_clock/short_hand");
    public static final ResourceLocation CUCKOO = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/cuckoo_clock/cuckoo");
    private static final ModelResourceLocation CUCKOO_MODEL = TanukiDecorFabricClient.standalone(CUCKOO);
