...
public class AntiqueClockBER extends ClockBER {
    ...
    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/antique_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/antique_clock/short_hand");
    public static final ResourceLocation PENDULUM = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/antique_clock/pendulum");
    ...
    public AntiqueClockBER(BlockEntityRendererProvider.Context pContext) {
    ...
    public void renderAdditional(ClockRenderHelper renderHelper, ClockBlockEntity blockEntity, MultiBufferSource bufferSource) {
        final float pendulumRotation = blockEntity.getBias() * getPendulumRotation(0.5F, 20 * Mth.DEG_TO_RAD, blockEntity.getLevel().getGameTime(), renderHelper.getPartialTick());
