...
public class GrandfatherClockBER extends ClockBER {

    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/grandfather_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/grandfather_clock/short_hand");
    public static final ResourceLocation PENDULUM = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/grandfather_clock/pendulum");
