...
import com.moigferdsrte.tanukidecor.block.entity.HourglassBlockEntity;
...
public class HourglassBER implements BlockEntityRenderer<HourglassBlockEntity> {
    ...
    public static final ResourceLocation SAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/hourglass/sand");
    ...
    public void render(HourglassBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay) {
        ...
        final BakedModel model = mc.getModelManager().getModel(TanukiDecorFabricClient.standalone(SAND));
