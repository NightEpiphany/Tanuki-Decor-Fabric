...
public class GingerbreadClockBER extends ClockBER {

    public static final ResourceLocation LONG_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/gingerbread_clock/long_hand");
    public static final ResourceLocation SHORT_HAND = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/gingerbread_clock/short_hand");
    public static final ResourceLocation PENDULUM = ResourceLocation.fromNamespaceAndPath(TanukiDecorFabric.MOD_ID, "block/gingerbread_clock/pendulum");
    ...
    public GingerbreadClockBER(BlockEntityRendererProvider.Context pContext) {
        super(pContext, SHORT_HAND, LONG_HAND,
                ROOT_POSITION,
                ROOT_PIVOT_POINT,
                HANDS_POSITION,
                new Vec3(8.0D / 16.0D, -2.0D / 16.0D, 0));
    }
